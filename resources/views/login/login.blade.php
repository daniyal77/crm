    ...
    >
        <div class="flex w-full max-w-sm grow flex-col justify-center p-5">
            ...
            <div class="mt-16">
                ...
                <div
                    class="mt-4 flex items-center justify-between space-x-2 space-x-reverse"
                >
                ...
                <div class="my-7 flex items-center space-x-3 space-x-reverse">
                ...
                <div class="flex space-x-4 space-x-reverse">
                    <button
                        class="btn w-full space-x-3 space-x-reverse border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90"
                    >
                        <img
                            class="size-5.5"
