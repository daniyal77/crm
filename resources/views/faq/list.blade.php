    ...
    >
        ...
        <main class="main-content w-full px-[var(--margin-x)] pb-8">
            ...
            <div class="relative flex flex-col items-center justify-center">
                <div
                    class="absolute right-0 top-0 -mt-8 hidden max-w-xs p-4 lg:block"
                >
                ...
                <div
                    class="inline-space mt-3 flex flex-wrap items-center justify-center"
                >
                ...
                <div class="col-span-12 lg:col-span-4 xl:col-span-3">
                    <div class="card p-4 sm:px-5">
                        <ul class="space-y-3.5 font-inter font-medium">
                            <li>
                                <a
                                    class="inline-flex items-center space-x-2 space-x-reverse tracking-wide text-primary outline-none dark:text-accent-light"
                                    href="#"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li>
                                <a
                                    class="group inline-flex items-center space-x-2 space-x-reverse tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                    href="#"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                            ...
                            <li>
                                <a
                                    class="group inline-flex items-center space-x-2 space-x-reverse tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-navy-800 dark:hover:text-navy-100 dark:focus:text-navy-100"
                                    href="#"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
